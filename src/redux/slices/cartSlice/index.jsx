...
export const fetchCart = createAsyncThunk('cart/fetchCart', async (_, { rejectWithValue }) => {
    try {
        const response = await axios.get(`${API_BASE_URL}/user/profile/cart`);
...
export const addToCart = createAsyncThunk('cart/addToCart', async (cartItem, { rejectWithValue }) => {
    try {
        const response = await axios.post(`${API_BASE_URL}/user/profile/cart`, cartItem);
        return response.data;
    } catch (error) {
...
export const updateQuantity = createAsyncThunk('cart/updateQuantity', async ({ productId, attributes, quantity }, { rejectWithValue }) => {
    try {
        const response = await axios.put(`${API_BASE_URL}/user/profile/cart`, {
            productId,
            attributes,
            quantity,
        });
...
export const removeFromCart = createAsyncThunk('cart/removeFromCart', async ({ productId, attributes }, { rejectWithValue }) => {
    try {
        const response = await axios.delete(`${API_BASE_URL}/user/profile/cart`, {
...
export const clearCart = createAsyncThunk('cart/clearCart', async (_, { rejectWithValue }) => {
    try {
        const response = await axios.delete(`${API_BASE_URL}/user/profile/cart/clear`);
        return response.data;
    } catch (error) {
